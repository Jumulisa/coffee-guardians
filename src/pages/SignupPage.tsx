...
const SignupPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 bg-gradient-to-br from-primary/5 to-secondary/5 animate-fade-in py-8">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8 animate-slide-down">
          ...
          <p className="text-muted-foreground mt-2">Join to protect your harvest</p>
        </div>
        ...
        <Card className="border-0 shadow-lg animate-slide-up">
          <CardHeader>
            ...
            <CardDescription>Sign up to start diagnosing coffee diseases</CardDescription>
          </CardHeader>
          <CardContent>
